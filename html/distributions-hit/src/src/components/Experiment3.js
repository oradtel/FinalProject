...
const Experiment3 = (props) => {
    ...
    useEffect(() => {
        (async () => {
            ...
            //console.log(10, data)
            let rowFromService1 = await getMyRow(2, 0, data);
            let rowFromService2 = await getMyRow(2, 5, data);
    ...
    const onSubmit = (data) => {
        var choice;
        if (isPicked1.picked){
            choice={choicePicked3:ID1,choiceNotPicked3:ID2};
        }else{
            choice={choicePicked3:ID2,choiceNotPicked3:ID1};
        }
        props.updateUser(choice);
        props.history.push('/experiment4');
    };
        ...
        <div>
            <Form className="input-form" onSubmit={handleSubmit(onSubmit)}>
                ...
                >
                    ...
                    <Form.Label style={{ width: '100%',left: '27%', display: 'flex', textAlign: 'center', position: 'relative'}}><h2><u>Experiment #3</u></h2></Form.Label>
                        <Form.Text as="big">
