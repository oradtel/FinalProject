...
const Experiment6 = (props) => {
    ...
    useEffect(() => {
        (async () => {
            ...
            //console.log(10, data)
            let rowFromService1 = await getMyRow(5, 0, data);
            let rowFromService2 = await getMyRow(5, 5, data);
        ...
        <div>
            <Form className="input-form" onSubmit={handleSubmit(onSubmit)}>
                ...
                >
                    ...
                    <Form.Label style={{ width: '100%',left: '27%', display: 'flex', textAlign: 'center', position: 'relative'}}><h2><u>Experiment #6</u></h2></Form.Label>
                        <Form.Text as="big">
