...
const Experiment9 = (props) => {
    ...
    useEffect(() => {
        (async () => {
            ...
            //console.log(10, data)
            let rowFromService1 = await getMyRow(8, 0, data);
            let rowFromService2 = await getMyRow(8, 5, data);
    ...
    const onSubmit = (data) => {
        var choice;
        if (isPicked1.picked){
            choice={choicePicked9:ID1,choiceNotPicked9:ID2};
        }else{
            choice={choicePicked9:ID2,choiceNotPicked9:ID1};
        }
        props.updateUser(choice);
        props.history.push('/experiment10');
    };
        ...
        <div>
            <Form className="input-form" onSubmit={handleSubmit(onSubmit)}>
                ...
                >
                    ...
                    <Form.Label style={{ width: '100%',left: '27%', display: 'flex', textAlign: 'center', position: 'relative'}}><h2><u>Experiment #9</u></h2></Form.Label>
                        <Form.Text as="big">
