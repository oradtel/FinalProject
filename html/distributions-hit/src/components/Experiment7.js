...
const Experiment7 = (props) => {
    ...
    const onSubmit = (data) => {
        var choice;
        if (isPicked1.picked){
            choice={choicePicked7:ID1,choiceNotPicked7:ID2};
        }else{
            choice={choicePicked7:ID2,choiceNotPicked7:ID1};
        }
        props.updateUser(choice);
        props.history.push('/experiment8');
    };
        ...
        <div>
            <Form className="input-form" onSubmit={handleSubmit(onSubmit)}>
                ...
                >
                    ...
                    <Form.Label style={{ width: '100%',left: '27%', display: 'flex', textAlign: 'center', position: 'relative'}}><h2><u>Experiment #7</u></h2></Form.Label>
                        <Form.Text as="big">
