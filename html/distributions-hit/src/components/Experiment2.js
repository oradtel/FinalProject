...
const Experiment2 = (props) => {
    ...
    useEffect(() => {
        (async () => {
            ...
            //console.log(10, data)
            let rowFromService1 = await getMyRow(1, 0, data);
            let rowFromService2 = await getMyRow(1, 5, data);
    ...
    const onSubmit = (data) => {
        var choice;
        if (isPicked1.picked){
            choice={choicePicked2:ID1,choiceNotPicked2:ID2};
        }else{
            choice={choicePicked2:ID2,choiceNotPicked2:ID1};
        }
        console.log(choice);
        props.updateUser(choice);
        props.history.push('/experiment3');
    };
        ...
        <div>
            <Form className="input-form" onSubmit={handleSubmit(onSubmit)}>
                ...
                >
                    ...
                    <Form.Label style={{ width: '100%',left: '27%', display: 'flex', textAlign: 'center', position: 'relative'}}><h2><u>Experiment #2</u></h2></Form.Label>
                        <Form.Text as="big">
